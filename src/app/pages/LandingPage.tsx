...
export function LandingPage() {
  ...
  return (
    <div className="w-full relative overflow-hidden bg-[#F0F4FF]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>

      {/* ── BACKGROUND ── */}
      <div className="absolute inset-0 pointer-events-none">
        {/* soft blue mesh */}
        <div className="absolute top-0 left-0 w-full h-[520px]"
          style={{ background: 'linear-gradient(160deg, #EEF2FF 0%, #F8FAFF 50%, #EDF5FF 100%)' }} />
        {/* glow blobs */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-6 shadow-sm"
              style={{ background: 'rgba(255,255,255,0.85)', border: '1px solid rgba(59,130,246,0.2)', backdropFilter: 'blur(8px)' }}>
            ...
            <p className="text-[15px] text-slate-500 leading-[1.75] mb-8 max-w-[460px]">
          ...
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.15 }}
            ...
            <div className="relative w-full max-w-[480px]">
              ...
              <div className="relative rounded-3xl p-6 shadow-2xl"
                style={{ background: 'rgba(255,255,255,0.82)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.9)' }}>
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div className="flex-1 rounded-2xl p-3 text-center shadow-sm"
                    ...
                    <div className="text-[9px] text-slate-400 uppercase tracking-widest mb-1">Plaintext</div>
                    <div className="text-[13px] font-bold font-mono text-slate-800">HELLO DES</div>
                  </div>
                  ...
                  <div className="flex-1 rounded-2xl p-3 text-center shadow-sm"
                    style={{ background: '#fff', border: '1px solid #E2E8F0' }}>
                    <div className="text-[9px] text-slate-400 uppercase tracking-widest mb-1">Ciphertext</div>
                ...
                <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl mb-4"
                  style={{ background: 'linear-gradient(135deg, #EEF2FF, #F0FEFF)', border: '1px solid rgba(99,102,241,0.15)' }}>
                  ...
                  <span className="text-[11px] font-mono text-slate-600">A1 3F 5D 7E 9C2B 4D</span>
                </div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="ml-auto text-[9px] text-slate-400 whitespace-nowrap">Ronde 8/16</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div key={f.title}
                ...
                style={{ background: 'rgba(255,255,255,0.85)', border: '1px solid rgba(226,232,240,0.8)', backdropFilter: 'blur(8px)' }}>
                ...
                <p className="text-[12px] text-slate-500 leading-[1.65]">{f.desc}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl p-5 shadow-sm"
              style={{ background: 'rgba(255,255,255,0.9)', border: '1px solid #E2E8F0', backdropFilter: 'blur(8px)' }}>
              <div className="flex items-center gap-2.5 mb-5">
                <div className="w-8 h-8 rounded-xl flex items-center justify-center"
                  style={{ background: 'linear-gradient(135deg,#DBEAFE,#BAE6FD)' }}>
                  <Lock className="w-4 h-4 text-blue-600" />
                </div>
                <span className="font-bold text-[13px] text-slate-800">Simulasi Enkripsi DES</span>
              </div>

              <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1.5">Plaintext</label>
              <input readOnly value="HELLO DES"
                className="w-full rounded-xl px-3.5 py-2.5 text-[13px] font-mono text-slate-800 mb-4 outline-none"
                style={{ background: '#F8FAFC', border: '1px solid #E2E8F0' }} />

              <div className="grid grid-cols-2 gap-3 mb-4">
                <div>
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1.5">Key (56-bit)</label>
                  <input readOnly value="A1 3F 5D 7E 9C 2B 4D"
                    className="w-full rounded-xl px-3 py-2.5 text-[10px] font-mono text-slate-700 outline-none"
                    style={{ background: '#F8FAFC', border: '1px solid #E2E8F0' }} />
                </div>
                <div>
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1.5">Mode</label>
                  <div className="flex items-center justify-between rounded-xl px-3 py-2.5 text-[13px] text-slate-700 cursor-pointer"
                    style={{ background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
                    <span>ECB</span>
            ...
            <div className="rounded-2xl p-5 shadow-sm"
              ...
              <div className="flex items-center gap-2.5 mb-5">
                ...
                <span className="font-bold text-[13px] text-slate-800">Proses Enkripsi DES (16 Ronde)</span>
              </div>
                  ...
                  <div key={i} className="flex items-center">
                    {step.isDot ? (
                      <div className="w-9 h-9 rounded-full flex items-center justify-center text-[14px] font-bold text-slate-400 flex-shrink-0"
                        style={{ background: '#F1F5F9', border: '1px solid #E2E8F0' }}>···</div>
                    ) : (
                      <div className="w-9 h-9 rounded-full flex items-center justify-center text-[11px] font-bold flex-shrink-0"
                        style={{
                          background: step.active ? 'linear-gradient(135deg,#2563EB,#3B82F6)' : '#F1F5F9',
                          border: step.active ? '2px solid #93C5FD' : '1px solid #E2E8F0',
                ...
                {processSteps.map((step, i) => (
                  <div key={i} className="flex items-start">
                    <div className="w-9 text-center"
                      style={{ fontSize: '8px', color: '#94A3B8', lineHeight: 1.4, whiteSpace: 'pre-wrap' }}>
                      {step.sub}
                    </div>
              ...
              {/* Progress */}
              <div className="h-1.5 rounded-full mb-2 overflow-hidden" style={{ background: '#EFF6FF' }}>
              ...
              <div className="px-3 py-2.5 rounded-xl text-center text-[11px] text-slate-500"
                style={{ background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
            ...
            <div className="rounded-2xl p-5 shadow-sm"
              ...
              <div className="flex items-center gap-2.5 mb-5">
                ...
                <span className="font-bold text-[13px] text-slate-800">Hasil Enkripsi</span>
              </div>

              {/* Cipher output */}
              <div className="p-4 rounded-xl mb-4"
                style={{ background: 'linear-gradient(135deg,#EFF6FF,#F0FEFF)', border: '1px solid #BFDBFE' }}>
                <div className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-2">Ciphertext (64-bit)</div>
                <div className="text-[20px] font-black font-mono text-slate-800" style={{ letterSpacing: '0.06em' }}>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="flex items-center gap-2 p-3 rounded-xl"
                  ...
                  <div>
                    ...
                    <div className="text-[9px] text-slate-400">Waktu Proses</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 p-3 rounded-xl"
                  style={{ background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
                  ...
                  <div>
                    ...
                    <div className="text-[9px] text-slate-400">Panjang Output</div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative px-6 md:px-12 lg:px-20 xl:px-28 pb-12 max-w-[1280px] mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.5 }}>
          <h2 className="text-[15px] font-bold text-slate-700 mb-4">Fokus pembelajaran DES</h2>
          <div className="rounded-2xl overflow-hidden shadow-sm"
            style={{ background: 'rgba(255,255,255,0.9)', border: '1px solid #E2E8F0' }}>
            <div className="grid grid-cols-2 h-11" style={{ borderBottom: '1px solid #E2E8F0' }}>
              <div className="flex items-center px-6 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Aspek</div>
              <div className="flex items-center px-6 text-[11px] font-bold text-blue-600 uppercase tracking-wider"
                style={{ borderLeft: '1px solid #E2E8F0' }}>DES</div>
            </div>
            {[
              ['Tipe',              'Block cipher'],
              ...
              <div key={row[0]} className="grid grid-cols-2 min-h-[44px]"
                ...
                <div className="flex items-center px-6 py-2 text-[13px] text-slate-500">{row[0]}</div>
                <div className="flex items-center px-6 py-2 text-[13px] text-slate-800 font-medium"
                  style={{ borderLeft: '1px solid #F1F5F9' }}>{row[1]}</div>
              </div>
            ))}
          </div>
        </motion.div>
      ...
      <section className="relative px-6 md:px-12 lg:px-20 xl:px-28 pb-16 max-w-[1280px] mx-auto">
        <motion.div
          ...
          style={{ background: 'linear-gradient(135deg, #EFF6FF 0%, #F0FEFF 100%)', border: '1px solid rgba(191,219,254,0.6)' }}>
          ...
          <div className="flex flex-col md:flex-row gap-5">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between flex-wrap gap-2 mb-3">
                <h3 className="text-[16px] font-bold text-slate-800">Apa itu DES?</h3>
              ...
              <p className="text-[13px] text-blue-900/70 mb-5" style={{ lineHeight: 1.75 }}>
                ...
                {[
                  ...
                  return (
                    <div key={f.title} className="flex gap-3 px-4 py-3.5 rounded-xl"
                      ...
                      <div>
                        <div className="text-[12px] font-bold text-slate-800 mb-0.5">{f.title}</div>
                        <div className="text-[11px] text-slate-500" style={{ lineHeight: 1.6 }}>{f.desc}</div>
                      </div>
                    </div>
                  );
                })}
      ...
      <div className="relative border-t px-6 md:px-12 lg:px-20 xl:px-28 py-6 max-w-[1280px] mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4"
        ...
        {[
          ...
          <div key={s.lbl} className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[15px] font-bold text-slate-800">{s.val}</div>
              <div className="text-[10px] text-slate-400 tracking-wide">{s.lbl}</div>
            </div>
          </div>
        ))}
      </div>
